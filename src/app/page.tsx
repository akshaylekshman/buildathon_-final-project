      ...
      <nav className="fixed top-0 w-full z-50 glass-panel border-b-0 border-white/10 dark:border-white/5 bg-background/60">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl tracking-tight">MediBridge AI</span>
          </div>
      ...
      <footer className="bg-card py-12 border-t border-border">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold tracking-tight text-foreground/80">MediBridge AI</span>
          </div>
          <p className="text-sm text-foreground/50">© 2026 MediBridge AI. All rights reserved.</p>
