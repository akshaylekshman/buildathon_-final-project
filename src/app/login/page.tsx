...
import { ArrowLeft, Mail, Lock, HeartPulse } from "lucide-react";

export default function LoginPage() {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-primary/20 via-background to-background"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <GlassCard className="p-8 sm:p-10">
          ...
          <div className="mt-8 flex items-center justify-center gap-2">
            ...
            <span className="text-xs text-foreground/50 uppercase font-medium">Or continue with</span>
            <span className="w-full h-px bg-border"></span>
          </div>

          <div className="grid grid-cols-2 gap-4 mt-6">
            <Button variant="outline" className="rounded-xl h-12 bg-card/50">Google</Button>
            <Button variant="outline" className="rounded-xl h-12 bg-card/50">Apple</Button>
          </div>
